    ...
    public void log(String message) {
        if (!isTestProfile()) {
            try {
                ...
                System.out.println(LogHandler.LOG_PREFIX + "Connection error: " + e);
            }
        }
    }
    ...
    public void registerComponent(String name) {
        if (!isTestProfile()) {
            ...
            try {
                ...
                System.out.println(LogHandler.LOG_PREFIX + "Could not register component: " + e);
            }
        }
    }
    ...
    public void recordInteraction(Interaction interaction) {
        if (!isTestProfile()) {
            try {
                ...
                System.out.println(LogHandler.LOG_PREFIX + "Could not record interaction: " + e);
            }
        }
    }
}
